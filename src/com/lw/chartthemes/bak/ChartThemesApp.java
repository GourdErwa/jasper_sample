...
public class ChartThemesApp{
    ...
    public static final String JASPER = "/lw/Information/my_Information/framework_technology/JasperReport/iReport/report/ichart/";
    ...
    public void fill() throws JRException {
        ...
        JasperFillManager.fillReportToFile(JASPER + "/AllChartsReport.jasper", parameters, new JREmptyDataSource());
    ...
    public void print() throws JRException {
        long start = System.currentTimeMillis();
        JasperPrintManager.printReport(JASPER + "/AllChartsReport.jrprint", true);
    ...
    public void pdf() throws JRException {
        long start = System.currentTimeMillis();
        JasperExportManager.exportReportToPdfFile(JASPER + "/AllChartsReport.jrprint");
    ...
    public void xml() throws JRException {
        long start = System.currentTimeMillis();
        JasperExportManager.exportReportToXmlFile(JASPER + "/AllChartsReport.jrprint", false);
    ...
    public void xmlEmbed() throws JRException {
        long start = System.currentTimeMillis();
        JasperExportManager.exportReportToXmlFile(JASPER + "/AllChartsReport.jrprint", true);
        System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
    }
    ...
    public void html() throws JRException {
        long start = System.currentTimeMillis();
        JasperExportManager.exportReportToHtmlFile(JASPER + "/AllChartsReport.jrprint");
    ...
    public void rtf() throws JRException {
        long start = System.currentTimeMillis();
        File sourceFile = new File(JASPER + "/AllChartsReport.jrprint");
    ...
    public static void putDataSources(Map<String, Object> parameters) throws JRException {
        try {
            ...
            JRCsvDataSource xyds1 = new JRCsvDataSource(JRLoader.getLocationInputStream(JASPER + "data/xyDatasource.csv"), "UTF-8");
